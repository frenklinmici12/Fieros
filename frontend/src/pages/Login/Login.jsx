...
function Login() {
    ...
    const submitForm = (user, pass) => {
        ...
        axios.post(url + "/auth/login", {
            ...
            //succesful login, update context for a logged in user, then take them to their profile
            //context
            setUser({
                loggedIn: true,
                username: user,
            ...
            <div>
                <div className="login-container">
                    ...
                    <div className="password">
                        ...
                        <input id="password" name="password" type={showPassword ? "text" : "password"} autoComplete="password" onChange={(e) => setPassword(e.target.value)} 
                            onKeyDown={(e) => {
                                if (e.key === 'Enter') {
